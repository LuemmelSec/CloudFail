...
# Cloudflare IP range sources
CF_IPS_V4_URL = "https://www.cloudflare.com/ips-v4"
CF_IPS_V6_URL = "https://www.cloudflare.com/ips-v6"
CF_API_IPS_URL = "https://api.cloudflare.com/client/v4/ips"
...
# Runtime state (toggled by CLI flags)
SSL_VERIFY: bool = True
DEBUG_MODE: bool = False
QUIET_MODE: bool = False

# Max rows shown in the subdomain table (terminal protection)
MAX_SUBDOMAIN_DISPLAY = 50

# Hardcoded Cloudflare IP ranges — fallback when live download fails
# Source: https://www.cloudflare.com/ips-v4 + /ips-v6 (updated 2025)
...
| |_____| | |_| | |_| ( (_| | |   / ___ | | |    \ V / (_____ |   /_| |
 \______)\_)___/|____/ \____|_|   \_____|_|\_)    \_/|_______|_)_____/ 
         ...
         v2.0 | 2026 Edition | Enhanced by FR13ND0x7f (Anmol K Sachan)
"""
